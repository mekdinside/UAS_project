...
{!! Form::model($file, ['method' => 'PUT', 'route' => ['admin.files.update', $file->id], 'files' => true,]) !!}
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-xs-12 form-group">
                ...
                {!! Form::select('folder_id', $folders, old('folder_id'), ['class' => 'form-control select2', 'required' => 'required']) !!}
                ...
                <div class="photo-block">
                    ...
                    <div class="files-list">
                        ...
                        <p class="form-group">
                            ...
                            <input type="hidden" name="filename_id[]" value="{{ $media->id }}">
                        </p>
                        @endforeach
                    </div>
                </div>
            ...
            $(this).fileupload({
                ...
                add: function(e, data) {
                    ...
                    $.each(data.result.files, function(index, file) {
                        var $line = $($('<p/>', {
                            class: "form-group"
                        }).html(file.name + ' (' + file.size + ' bytes)').appendTo($parent.find('.files-list')));
